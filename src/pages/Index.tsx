...
import { AnomalyScoreDistribution } from "@/components/AnomalyScoreDistribution";
import { DispersionMetrics } from "@/components/DispersionMetrics";
    ...
    async (file: File) => {
      try {
        if (file.size > 200 * 1024 * 1024) {
          // 200MB
          console.warn(
            `Warning: You are attempting to load a large file (${(
              file.size /
              1024 /
              1024
            ).toFixed(2)} MB). ` +
          ...
          <div className="space-y-12 animate-fade-in">
            ...
            <div className="text-center max-w-3xl mx-auto space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                Upload any CSV dataset and our ensemble ML engine will
                automatically infer schema, preprocess data, train multiple
                models, and identify anomalies with high accuracy.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Automatically infers column types and relationships",
                },
                {
                  icon: Layers,
                ...
                },
                {
                  ...
                  description:
                    "Visual charts and detailed anomaly explanations",
                },
              ].map((feature, index) => (
                <div
                  key={feature.title}
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">
                  Processed {result.summary.rows.toLocaleString()} rows across{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <MetricsCard
                ...
                subtitle={`${(
                  (result.summary.anomalyCount / result.summary.rows) *
                  100
                ).toFixed(1)}% of data`}
                icon={AlertTriangle}
                variant="anomaly"
              ...
              <MetricsCard
                title="F1 Score"
                value={
                  result.evaluation.f1Score
                    ? `${(result.evaluation.f1Score * 100).toFixed(1)}%`
                    : "—"
                }
                icon={TrendingUp}
                variant="success"
            ...
            {/* New Analytics Section - Efficiency & Disparities */}
            <div className="border-t border-border/50 pt-8 mt-8">
              ...
              <DataQualityMetrics schema={result.schema} />

              {/* Anomaly Score Distribution */}
              <div className="mt-8">
                <AnomalyScoreDistribution results={result.results} />
              </div>
      ...
      <footer className="border-t border-border/50 mt-12">
        <div className="container mx-auto px-6 py-6">
          <p className="text-center text-sm text-muted-foreground">
            Powered by ensemble machine learning • IsolationForest • LightGBM •
            LOF • HBOS
          </p>
        </div>
      </footer>
